...
const Content = styled.div`
  padding: 0 20px ${(props) => (props.$hideTabBar ? "120px" : "120px")} 20px; /* 탭 바 숨김 여부에 따라 하단 패딩 조정 (수정 모드에서는 60px 여백 추가) */
  display: flex;
...
const CreateMeetingPage = () => {
  ...
  // 수정 모드 확인
  const isEditMode =
    searchParams.get("mode") === "edit" || location.state?.editMode;
